...
public class QueryCommandTests
{
    ...
    private sealed class ValidationHarnessViewModel : QueryValidationViewModelBase
    {
    ...
    private sealed class MissingDispatcherViewModel : QueryValidationViewModelBase
    {
